<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_ReportHeader(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<td width="50%" align="left"><?php /* tag "B" from line 252 */; ?>
...
<td width="50%" align="left"></td>
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_StyleTools(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div id="style-switcher">
		<?php /* tag "i" from line 236 */; ?>
<i class="glyphicon glyphicon-arrow-left"></i>
		<?php /* tag "span" from line 237 */; ?>
<span>Giao diện:</span>
...
<a href="/setting/theme/red-green" alt="#red-green" style="background-image:url('/mvc/templates/theme/cms/img/demo/red-green.png');background-repeat:no-repeat;cursor:pointer;"></a>
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div id="footer" class="col-12" style="text-align:right; padding-right:20px;">
			2011 - 2013 &copy; <?php /* tag "a" from line 228 */; ?>
<a href="https://www.spn-soft.com">SPN Group</a>
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_MenuSetting(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-cogwheel"></i>CẤU HÌNH
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_MenuApp(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-drink"></i>BÁN HÀNG (N)</a>
			</li>
			<?php 
...
<i class="glyphicons-keys"></i>ĐỔI MẬT KHẨU</a>
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_PageBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_ContentHeader(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<h1>HỆ THỐNG QUẢN LÝ QUÁN ĂN LÀNG CHÀI</h1></div><?php 
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="current"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<span class="text"><?php echo phptal_escape(\MVC\Base\SessionRegistry::instance()->getCurrentUser()->getEmail()); ?>
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script src="/mvc/templates/theme/cms/js/jquery.masonry.min.js"></script>
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
/>										
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="shortcut icon" type="image/png" href="/data/images/app/icon.png"/>
 ...
 ?>
<?php 
function tpl_528f0c11_mAdmin__u8a434MezIn4KDR0HJqt_A(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
