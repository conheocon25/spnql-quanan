<?php 
function tpl_5295522b_ReportDetail__WaSZxAOZFiLaT1ixfxqFug(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td class="center"><?php 
/* tag "a" from line 61 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->Tracking, 'getURLReportPayRollSave')))):  ;
$_tmp_1 = ' href="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
<td><?php 
/* tag "a" from line 66 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->Tracking, 'getURLCollectGeneral')))):  ;
$_tmp_1 = ' href="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
<td class="center"><?php 
/* tag "a" from line 73 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->Tracking, 'getURLStoreSave')))):  ;
$_tmp_1 = ' href="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
<td><?php 
/* tag "a" from line 82 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->Tracking, 'getURLCourse')))):  ;
$_tmp_1 = ' href="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
