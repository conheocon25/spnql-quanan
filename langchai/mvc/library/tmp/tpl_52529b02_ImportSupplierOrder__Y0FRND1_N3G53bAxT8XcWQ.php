<?php 
function tpl_52529b02_ImportSupplierOrder__Y0FRND1_N3G53bAxT8XcWQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript">
		/*<![CDATA[*/
			...
			$('#URLUpdButton').click(function(){
				...
				var URL = "/import/"+Data[0]+"/"+Data[1]+"/"+Data[2]+"/"+Data[3]+"/"+Data[4];
				$.ajax({
					type: "POST",					
					url: URL,
...
Generated by PHPTAL from I:\quanly-quanan\langchai\mvc\templates\ImportSupplierOrder.html (edit that file instead) */; ?>