<?php 
function tpl_520bc755_ReportSellingDetail__9xVH9G4yZRVuH67_R3vTHg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<th width="18%" align="left"><?php /* tag "B" from line 25 */; ?>
<B>THỜI GIAN</B></th>
			<?php /* tag "th" from line 26 */; ?>
<th width="18%" align="left"><?php /* tag "B" from line 26 */; ?>
<B>NHÂN VIÊN</B></th>
			<?php /* tag "th" from line 27 */; ?>
<th width="37%" align="left"><?php /* tag "B" from line 27 */; ?>
<B>BÀN</B></th>
			<?php /* tag "th" from line 28 */; ?>
<th width="22%" align="right"><?php /* tag "B" from line 28 */; ?>
<B>GIÁ TRỊ</B></th>
		</tr>
		<?php 
/* tag "tr" from line 30 */ ;
...
<td align="left"><?php echo phptal_escape($ctx->D[2]); ?>
</td>
			<?php /* tag "td" from line 34 */; ?>
<td align="left"><?php echo phptal_escape($ctx->D[3] . ' / ' . $ctx->D[4]); ?>
</td>
			<?php /* tag "td" from line 35 */; ?>
<td align="right"><?php echo phptal_escape($ctx->D[6]); ?>
</td>
		</tr><?php 
endforeach ;
$ctx = $tpl->popContext() ;
...
<th align="right" colspan="5" width="78%"><?php /* tag "H3" from line 38 */; ?>
<H3>TỔNG</H3></th>			
			<?php /* tag "th" from line 39 */; ?>
<th align="right" width="22%"><?php /* tag "B" from line 39 */; ?>
...
Generated by PHPTAL from I:\quanly-quanan\langchai\mvc\templates\ReportSellingDetail.html (edit that file instead) */; ?>