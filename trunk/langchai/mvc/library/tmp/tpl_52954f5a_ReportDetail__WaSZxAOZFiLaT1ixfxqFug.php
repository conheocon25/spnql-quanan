<?php 
function tpl_52954f5a_ReportDetail__WaSZxAOZFiLaT1ixfxqFug(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td class="center"><?php 
/* tag "a" from line 61 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->Tracking, 'getURLReportPayRollSave')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<td><?php 
/* tag "a" from line 62 */ ;
if (null !== ($_tmp_3 = ($ctx->path($ctx->Tracking, 'getURLReportPayRoll')))):  ;
$_tmp_3 = ' href="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
...
<td><?php 
/* tag "a" from line 66 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->Tracking, 'getURLCollectGeneral')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<td class="center"><?php 
/* tag "a" from line 69 */ ;
if (null !== ($_tmp_3 = ($ctx->path($ctx->Tracking, 'getURLPaidGeneralSave')))):  ;
$_tmp_3 = ' href="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
...
<td class="center"><?php 
/* tag "a" from line 73 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->Tracking, 'getURLStoreSave')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<td><?php 
/* tag "a" from line 74 */ ;
if (null !== ($_tmp_3 = ($ctx->path($ctx->Tracking, 'getURLStore')))):  ;
$_tmp_3 = ' href="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
...
<td><?php 
/* tag "a" from line 82 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->Tracking, 'getURLCourse')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<td><?php 
/* tag "a" from line 86 */ ;
if (null !== ($_tmp_3 = ($ctx->path($ctx->Tracking, 'getURLResource')))):  ;
$_tmp_3 = ' href="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
