<?php 
function tpl_52b79ad7_SettingCategory__5iLNcBmUfLD9zaaQfPVIQw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div class="modal-header"><?php /* tag "h3" from line 60 */; ?>
<h3><?php /* tag "i" from line 60 */; ?>
...
<button id="URLInsButton" class="btn btn-primary btn-small" type="submit" value="Validate"><?php /* tag "i" from line 69 */; ?>
<i class="glyphicons-download_alt"></i> Lưu</button>
										<?php /* tag "button" from line 70 */; ?>
<button data-dismiss="modal" class="btn btn-default btn-small"><?php /* tag "i" from line 70 */; ?>
...
<button id="URLUpdButton" class="btn btn-primary btn-small" type="submit" value="Validate"><?php /* tag "i" from line 91 */; ?>
<i class="glyphicons-download_alt"></i> Lưu</button>
										<?php /* tag "button" from line 92 */; ?>
<button data-dismiss="modal" class="btn btn-default btn-small"><?php /* tag "i" from line 92 */; ?>
<i class="glyphicons-undo"></i> Hủy</button>
									</div>
								</form>
							</div>
...
Generated by PHPTAL from D:\AppWebServer\SPN_QuanAn\baduc\mvc\templates\SettingCategory.html (edit that file instead) */; ?>