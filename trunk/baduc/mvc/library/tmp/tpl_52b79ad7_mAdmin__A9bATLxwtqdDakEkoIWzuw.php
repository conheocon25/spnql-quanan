<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_ReportHeader(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<td width="50%" align="left"></td>
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_StyleTools(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="/setting/theme/red-green" alt="#red-green" style="background-image:url('/mvc/templates/theme/cms/img/demo/red-green.png');background-repeat:no-repeat;cursor:pointer;"></a>
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="https://www.spn-soft.com">SPN Group</a>
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_MenuSetting(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-cogwheel"></i>CẤU HÌNH
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_MenuApp(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-keys"></i>ĐỔI MẬT KHẨU</a>
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_PageBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_ContentHeader(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<h1>HỆ THỐNG QUẢN LÝ QUÁN ĂN BA ĐỨC</h1></div><?php 
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="current"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<span class="text"><?php echo phptal_escape(\MVC\Base\SessionRegistry::instance()->getCurrentUser()->getEmail()); ?>
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script src="/mvc/templates/theme/cms/js/pdfobject.js"></script>
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
/>										
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="shortcut icon" type="image/png" href="/data/images/app/icon.png"/>
 ...
 ?>
<?php 
function tpl_52b79ad7_mAdmin__A9bATLxwtqdDakEkoIWzuw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
