<?php 
function tpl_52b79ad7_SettingDomain__sAUaVY2sVYaqiYnbO015aw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div class="modal-header"><?php /* tag "h3" from line 52 */; ?>
<h3><?php /* tag "i" from line 52 */; ?>
<i class="glyphicons-show_big_thumbnails modal-icon"></i>THÊM MỚI KHU VỰC</h3></div>								
...
<button id="URLInsButton" class="btn btn-primary btn-small"><?php /* tag "i" from line 63 */; ?>
...
<div class="modal-header"><?php /* tag "h3" from line 76 */; ?>
<h3><?php /* tag "i" from line 76 */; ?>
<i class="glyphicons-show_big_thumbnails modal-icon"></i>CẬP NHẬT KHU VỰC</h3></div>
								<?php /* tag "form" from line 77 */; ?>
...
<button id="URLUpdButton" class="btn btn-primary btn-small" type="submit"><?php /* tag "i" from line 85 */; ?>
<i class="glyphicons-download_alt"></i> Lưu</button>
...
Generated by PHPTAL from D:\AppWebServer\SPN_QuanAn\baduc\mvc\templates\SettingDomain.html (edit that file instead) */; ?>