<?php		
	...
	class ReportDetailType3 extends Command{
		function doExecute( \MVC\Controller\Request $request ){
			...
			while ($SDs->valid()){
				...
				while (strtotime($Date) < strtotime($EndDate)){
					...
					//Định dạng lại gọn
					$D1[] = "(".\date("d-m", strtotime($Date))." đến ".\date("d-m", strtotime($DateTemp))."): ".$Count;
					$D2[] = (int)($Count);
			...
			$Title1 = "BÁO CÁO / CHI TIẾT / THỨC ĂN / ".$Tracking->getDateStartPrint()." ĐẾN ".$Tracking->getDateEndPrint();
			$Title2 = "BÁO CÁO / BIỀU ĐỒ / THỨC ĂN / ".$Tracking->getDateStartPrint()." ĐẾN ".$Tracking->getDateEndPrint();
