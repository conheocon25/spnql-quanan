<?php 
function tpl_52b79ad7_SettingSupplier__mguu4T9YzuAfNtPxsixmdQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<button id="URLInsButton" class="btn btn-primary btn-small" type="submit" value="Validate"><?php /* tag "i" from line 99 */; ?>
...
<button id="URLUpdButton" class="btn btn-primary btn-small" type="submit"><?php /* tag "i" from line 145 */; ?>
<i class="glyphicons-download_alt"></i> Lưu</button>
...
Generated by PHPTAL from D:\AppWebServer\SPN_QuanAn\baduc\mvc\templates\SettingSupplier.html (edit that file instead) */; ?>