<?php 
function tpl_52b79ad7_SettingTermCollect__dKNzLfpk4mMdNg3lrarDHg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
/* tag "tr" from line 34 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->Term = new PHPTAL_RepeatController($ctx->TermCollectAll1)
 ;
$ctx = $tpl->pushContext() ;
...
<i class="glyphicons-disk_save modal-icon"></i>THÊM MỚI KHOẢN THU</h3>
								</div>
								<?php /* tag "form" from line 60 */; ?>
<form id="FormTermCollectInsert" action="#" class="form-horizontal" novalidate="novalidate">
...
<form id="FormTermCollectUpdate" action="#" class="form-horizontal" novalidate="novalidate">
...
<script type="text/javascript">
		/*<![CDATA[*/
			...
			$("#FormTermCollectInsert").validate({
				rules:{
					Name1:{
						minlength: 2,
						required:true
			...
			//-----------------------------------------------------------------------------------			
			$("#FormTermCollectUpdate").validate({
				rules:{
					Name2:{
						minlength: 2,
						required:true
...
Generated by PHPTAL from D:\AppWebServer\SPN_QuanAn\baduc\mvc\templates\SettingTermCollect.html (edit that file instead) */; ?>