...
class OrderImportDetail extends Mapper implements \MVC\Domain\OrderImportDetailFinder {
    ...
    function __construct() {
		...
		$tblResource = "r3d_resource";
		$tblOrderImport = "r3d_order_import";
		$tblOrderImportDetail = "r3d_order_import_detail";
		$tblSessionDetail = "r3d_session_detail";
		$tblR2C = "r3d_r2c";
		...
		$trackByExportStmt = sprintf("
			...
			from
				r3d_session S inner join r3d_session_detail SD on S.id = SD.idsession
			where
				SD.idcourse IN(select id_course from r3d_r2c where id_resource=?) AND
